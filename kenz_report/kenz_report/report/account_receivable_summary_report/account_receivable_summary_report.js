...
frappe.query_reports["Account Receivable Summary Report"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
	...
	onload: function (report) {
		report.page.add_inner_button(__("Accounts Receivable"), function () {
			...
			frappe.set_route("query-report", "Account Receivable Report", { company: filters.company });
		});
...
erpnext.utils.add_dimensions("Account Receivable Summary Report", 9);
